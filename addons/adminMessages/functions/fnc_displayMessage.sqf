...
if (
    ...
    _ctrlText ctrlSetStructuredText parseText format ["<t color='#E51919'>%1</t> %2",format [localize "STR_gc_websiteFunctionsClient_CHANNEL",_info],_message];
...
GVAR(channel) radioChannelSetCallsign format [localize "STR_gc_websiteFunctionsClient_CHANNEL",_info];
