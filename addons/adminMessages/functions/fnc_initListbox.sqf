...
if (!isNil QGVAR(latestConvos) && {count GVAR(latestConvos) > 0}) then {
    ["STR_gc_websiteFunctionsClient_LATESTCONVOS"] call _fnc_addHeadline;
    {
...
//BY SIDE ======================================================================
["STR_gc_websiteFunctionsClient_BYCATEGORY"] call _fnc_addHeadline;
[localize "STR_gc_websiteFunctionsClient_EVERYONE",-2] call _fnc_addEntry;
[localize "STR_gc_websiteFunctionsClient_OTHERADMINS",-3] call _fnc_addEntry;
...
//LIST OF PLAYERS ==============================================================
["STR_gc_websiteFunctionsClient_BYPLAYER"] call _fnc_addHeadline;
private _playerData = [];
{
