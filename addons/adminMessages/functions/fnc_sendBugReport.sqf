...
if ([] call FUNC(isAdminOrZeus)) then {
    ...
    [format ["%1 %2",localize "STR_gc_websiteFunctionsClient_TO",_lbText],_message] call FUNC(displayMessage);
    ...
    // display sent message locally
    [format ["%1 %2",localize "STR_gc_websiteFunctionsClient_TO","Admin"],_message] call FUNC(displayMessage);
